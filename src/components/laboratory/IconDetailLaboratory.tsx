...
export const IconDetailLaboratory: React.FC<IconDetailLaboratoryProps> = ({
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-5xl my-auto rounded-2xl bg-[#0a0a0a] border border-white/10 shadow-2xl overflow-hidden flex flex-col max-h-[92vh] text-[#e5e5e5]">
        {/* Top Header Bar */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-white/10 bg-[#050505]/80">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <button
                ...
                className="px-2.5 py-1.5 rounded-lg border border-white/10 bg-white/5 text-xs font-mono text-white/70 hover:bg-white/10 hover:text-white flex items-center gap-1.5 transition-colors cursor-pointer"
            ...
            <button
              type="button"
              onClick={onClose}
              className="p-2 rounded-lg border border-white/10 bg-white/5 text-white/40 hover:text-white hover:bg-white/10 transition-colors cursor-pointer"
              title="Close (Esc)"
        ...
        <div className="flex-1 overflow-y-auto grid grid-cols-1 lg:grid-cols-12 divide-y lg:divide-y-0 lg:divide-x divide-white/10">
          ...
          <div className="lg:col-span-7 p-6 space-y-6">
            ...
            <div className="space-y-3">
                ...
                {icon.hasAnimation ? (
                  <div className="inline-flex p-1 rounded-lg bg-white/5 border border-white/10">
                    ...
                    <button
                      ...
                      className={`px-3 py-1 text-xs font-mono font-medium rounded-md transition-all flex items-center gap-1.5 cursor-pointer ${
                        settings.animated
                          ? 'bg-blue-600 text-white font-bold shadow-xs'
                          : 'text-white/40 hover:text-white'
                      }`}
              ...
              {compareMode && icon.hasAnimation ? (
                <div className="grid grid-cols-2 gap-4">
                  {/* Static Preview Box */}
                  <div className="flex flex-col items-center justify-center p-8 rounded-2xl border border-white/10 bg-black relative min-h-56">
                  ...
                  <div className="flex flex-col items-center justify-center p-8 rounded-2xl border border-blue-500/40 bg-blue-950/20 relative min-h-56">
                ...
                <div
                  className={`relative flex items-center justify-center rounded-2xl border border-white/10 min-h-64 sm:min-h-72 transition-all overflow-hidden ${stageBgClass}`}
                  style={customStyle}
                >
                  ...
                  {/* Icon Rendering */}
                  <div className="relative z-10 flex items-center justify-center p-8 transition-transform">
                    <AnimatedIconRenderer
                      icon={icon}
                      size={settings.size}
                      color={settings.color}
                  ...
                  <div className="absolute bottom-3 right-3 text-[10px] font-mono text-blue-400 bg-blue-900/30 px-2 py-1 rounded border border-blue-500/20 backdrop-blur-xs">
                    {settings.size} x {settings.size} • stroke: {settings.strokeWidth}px
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="space-y-4 pt-2">
                ...
                <div className="flex items-center gap-1.5">
                  {(['transparent', 'light', 'dark', 'checkerboard'] as const).map(bg => (
                    <button
                      ...
                      className={`px-2.5 py-1 rounded-lg text-[11px] font-mono capitalize transition-all border cursor-pointer ${
              ...
              <div className="grid grid-cols-12 gap-3 items-center text-xs">
                <span className="col-span-3 font-mono text-white/50">
                ...
                <div className="flex items-center justify-between text-xs pt-2 border-t border-white/10">
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="px-2.5 py-1 rounded-lg text-[11px] font-mono border border-white/10 bg-white/5 text-white/80 hover:bg-white/10 cursor-pointer"
                    >
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    {[0.5, 1, 1.5, 2].map(spd => (
                      <button
                        ...
                        className={`px-2 py-0.5 text-[10px] font-mono rounded-lg border cursor-pointer ${
                          settings.speed === spd
                            ? 'bg-blue-600 border-blue-500 text-white font-bold'
            ...
            <div className="pt-2 flex flex-wrap items-center gap-3">
              <button
                ...
                className="flex-1 min-w-[140px] px-4 py-3 rounded-xl font-bold text-xs sm:text-sm bg-blue-600/10 border border-blue-500/20 text-blue-400 hover:bg-blue-600 hover:text-white transition-all flex items-center justify-center gap-2 cursor-pointer shadow-sm"
              >
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <button
                ...
                className="px-4 py-3 rounded-xl font-medium text-xs sm:text-sm border border-white/10 bg-white/5 text-white/80 hover:bg-white/10 hover:text-white transition-colors flex items-center gap-2 cursor-pointer"
              ...
              {icon.hasAnimation && (
                <button
                  ...
                  className="px-4 py-3 rounded-xl font-medium text-xs sm:text-sm border border-blue-500/20 bg-blue-500/10 text-blue-400 hover:bg-blue-500/20 transition-colors flex items-center gap-2 cursor-pointer"
            ...
            {relatedIcons.length > 0 && (
              <div className="pt-4 border-t border-white/10">
                <h4 className="text-xs font-mono font-medium text-white/50 mb-2.5">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  {relatedIcons.map(rel => (
                    <button
                      ...
                      className="p-2.5 rounded-xl border border-white/10 bg-white/5 hover:border-blue-500/50 hover:bg-blue-500/10 hover:text-blue-400 text-white/70 transition-all cursor-pointer"
                      title={rel.name}
                    >
          ...
          <div className="lg:col-span-5 p-6 flex flex-col bg-[#050505]/60">
            <div className="flex items-center justify-between pb-3 border-b border-white/10 mb-3">
              ...
              <button
                ...
                className="px-3 py-1.5 text-xs font-mono font-medium rounded-lg bg-blue-600 hover:bg-blue-500 text-white transition-colors flex items-center gap-1.5 shadow-md shadow-blue-600/20 cursor-pointer"
              >
                {copied ? (
                  <>
            ...
            <div className="flex items-center gap-1.5 overflow-x-auto pb-2 mb-3 scrollbar-none">
              {(['react', 'svg', 'html', 'vue', 'svelte', 'angular', 'css'] as FrameworkType[]).map(fw => (
                <button
                  ...
                  className={`px-2.5 py-1 text-xs font-mono rounded-lg uppercase transition-all shrink-0 border cursor-pointer ${
                    activeTab === fw
            ...
            <div className="flex-1 min-h-[260px] rounded-xl bg-black text-blue-300 p-4 font-mono text-[11px] overflow-auto border border-white/5 shadow-inner leading-relaxed">
            ...
            {/* Metadata Footer */}
            <div className="mt-4 pt-3 border-t border-white/10 space-y-1.5 text-[11px] font-mono text-white/40">
              <div className="flex items-center justify-between">
                <span>Category:</span>
              ...
              <div className="flex items-center justify-between">
                <span>License:</span>
                <span className="font-semibold text-emerald-400">MIT (Free for commercial use)</span>
              </div>
            </div>
          </div>
        </div>
