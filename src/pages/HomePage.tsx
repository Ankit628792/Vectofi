            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              ...
              >
                <div className="relative flex items-center">
                  ...
                  <button
                    type="submit"
                    className="absolute right-1.5 px-4 py-1.5 rounded-full text-xs font-semibold bg-blue-600 hover:bg-blue-500 text-white shadow-md shadow-blue-600/20 transition-colors cursor-pointer"
                  >
                    Search
                  </button>
                </div>
              ...
              <div className="pt-2 flex flex-wrap items-center justify-center lg:justify-start gap-4">
                <button
                  ...
                  className="bg-blue-600 px-8 py-3 rounded-xl font-bold text-sm text-white hover:bg-blue-500 shadow-lg shadow-blue-600/20 transition-all cursor-pointer"
                >
                  Browse the Gallery
                </button>
                ...
                <button
                  ...
                  className="border border-white/10 bg-white/5 px-8 py-3 rounded-xl font-bold text-sm text-white hover:bg-white/10 transition-all cursor-pointer"
                >
                  View Documentation
                </button>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-8">
            ...
            <button
              type="button"
              onClick={() => onNavigate('/icons')}
              className="px-5 py-2.5 rounded-full text-xs font-bold bg-blue-600 hover:bg-blue-500 text-white transition-colors flex items-center gap-1.5 shadow-md shadow-blue-600/20 cursor-pointer"
            >
          ...
          <div className="relative z-10 max-w-2xl space-y-4">
            ...
            <div className="pt-2 flex flex-wrap gap-4">
              <button
                type="button"
                onClick={() => onNavigate('/icons')}
                className="px-6 py-3 rounded-xl font-bold text-sm bg-blue-600 text-white hover:bg-blue-500 transition-colors shadow-lg shadow-blue-600/20 cursor-pointer"
              >
                Browse All Icons
              </button>
              <button
                type="button"
                onClick={() => onNavigate('/docs')}
                className="px-6 py-3 rounded-xl font-bold text-sm border border-white/10 bg-white/5 text-white hover:bg-white/10 transition-colors cursor-pointer"
              >
                Read Framework Docs
              </button>
            </div>
