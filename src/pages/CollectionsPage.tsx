    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 text-[#e5e5e5]">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
        ...
        <button
          ...
          className="px-4 py-2.5 rounded-xl text-xs font-mono font-semibold bg-blue-600 hover:bg-blue-500 text-white transition-colors flex items-center gap-2 shadow-lg shadow-blue-600/20 cursor-pointer"
        >
            ...
            return (
              ...
              >
                <div className="min-w-0 pr-2">
                  ...
                  <span className="inline-block mt-2 text-[10px] font-mono px-2 py-0.5 rounded-md bg-white/5 border border-white/10 text-white/50">
              ...
              <div className="p-4 sm:p-6 rounded-2xl border border-white/10 bg-[#0a0a0a] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                {collectionIcons.length > 0 && (
                  ...
                  >
                    ...
                    Batch Download All ({collectionIcons.length})
                  </button>
                )}
              </div>
