...
console.log(`Current icons: ${existingSlugs.size}. Need at least 70 more for 1,020+ icons.`);
...
for (const file of lucideFiles) {
  if (additionalList.length >= 85) break;
...
console.log(`Selected ${additionalList.length} additional icons to reach 1,035 total.`);
